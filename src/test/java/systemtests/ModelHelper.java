...
public class ModelHelper {
    private static final Predicate<Volunteer> PREDICATE_MATCHING_NO_PERSONS = unused -> false;
    ...
    public static void setFilteredList(Model model, List<Volunteer> toDisplay) {
        ...
        model.updateFilteredVolunteerList(predicate.orElse(PREDICATE_MATCHING_NO_PERSONS));
    }
