...
public class MainWindow extends UiPart<Stage> {
     ...
     */
    void fillInnerParts() {
        browserPanel = new BrowserPanel(logic.selectedBeneficiaryProperty());
        browserPlaceholder.getChildren().add(browserPanel.getRoot());

        beneficiaryListPanel = new BeneficiaryListPanel(logic.getFilteredBeneficiaryList(), logic.selectedBeneficiaryProperty(),
                logic::setSelectedBeneficiary);
